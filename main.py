...
from utils import wrangle, graph_predictions, get_metrics, loadify, get_workload, integrated_gradients
from train import train_model
import neptune
import time


model_select = 'Transformer'  # 'Transformer' or 'LSTM' or 'vLSTM'
...
saved_mpath = model_select + '/Transformer_o300.pth'
